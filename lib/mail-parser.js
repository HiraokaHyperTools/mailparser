...
class IconvLiteWrapperWithDecodeStreamAndSupportsIso2022jp {
    decodeStream(charset) {
        if (charset.toLowerCase().replace(/-/g, "") == "iso2022jp") {
...
const iconv = new IconvLiteWrapperWithDecodeStreamAndSupportsIso2022jp();
